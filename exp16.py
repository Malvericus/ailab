...
def nim_game():
    ...
    while sticks > 0:
        ...
        if current_player == "computer":
            # Computer always makes a poor move
            if sticks <= 4:
                # In endgame, always leave at least 1 stick for player to win
                move = sticks - 1 if sticks > 1 else 1
            else:
                # Always take 1 unless there's only 1 left
                move = 1
